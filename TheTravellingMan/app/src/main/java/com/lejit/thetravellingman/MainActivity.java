...
public class MainActivity extends AppCompatActivity implements
        ItenaryPlanner.OnFragmentInteractionListener, FoodNearby.OnFragmentInteractionListener, AttractionsNearby.OnFragmentInteractionListener
{
        ...
        bottomBar.setOnTabSelectListener(new OnTabSelectListener() {
            ...
            public void onTabSelected(@IdRes int tabId) {
                if (tabId == R.id.tab_information) {
                    ...
                    transaction.replace(R.id.MainFragment, new AboutSG_fragment());
