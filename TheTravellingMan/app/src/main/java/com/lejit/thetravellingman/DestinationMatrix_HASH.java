...
/**
 * Created by MY LENOVO on 17/11/2016.
 */
public class DestinationMatrix_HASH {
    public static final HashMap<String,Integer> destination_matrix1=new HashMap<String, Integer>();
    static {
        destination_matrix1.put("Marina Bay Sands",0);
        destination_matrix1.put("Singapore Flyer",1);
        destination_matrix1.put("VivoCity",2);
        destination_matrix1.put("Resorts World Sentosa",3);
        destination_matrix1.put("Buddha Tooth Relic Temple",4);
        destination_matrix1.put("The Singapore Zoo",5);
    }
    final static int TotNum=destination_matrix1.size();
