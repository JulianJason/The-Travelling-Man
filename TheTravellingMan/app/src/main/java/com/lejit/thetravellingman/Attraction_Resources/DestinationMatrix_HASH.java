package com.lejit.thetravellingman.Attraction_Resources;
 ...
 */
public class DestinationMatrix_HASH {
    ...
    static {
        ...
        costArray[1][3][0]=1.18;
        costArray[1][3][1]=1.16;
        costArray[1][3][2]=0.00;
        ...
        costArray[1][4][3]=3.98;
        costArray[1][4][5]=1.91;

        costArray[1][5][0]=1.88;
        costArray[1][5][1]=1.96;
        costArray[1][5][2]=2.11;
        costArray[1][5][3]=4.99;
        costArray[1][5][4]=1.99;
        ...
        costArray[2][1][0]=10.77;
        costArray[2][1][2]=10.82;
        costArray[2][1][3]=11.38;
        costArray[2][1][4]=9.70;
        costArray[2][1][5]=23.75;

        costArray[2][2][0]=15.45;
        costArray[2][2][1]=12.18;
        costArray[2][2][3]=9.15;
        costArray[2][2][4]=9.97;
        costArray[2][2][5]=27.60;

        costArray[2][3][0]=13.82;
        costArray[2][3][1]=14.92;
        costArray[2][3][2]=9.15;
        costArray[2][3][4]=11.90;
        costArray[2][3][5]=33.62;

        costArray[2][4][0]=9.15;
        costArray[2][4][1]=9.70;
        costArray[2][4][2]=9.97;
        costArray[2][4][3]=11.62;
        costArray[2][4][5]=28.95;

        costArray[2][5][0]=24.58;
        costArray[2][5][1]=23.75;
        costArray[2][5][2]=27.60;
        costArray[2][5][3]=38.62;
        costArray[2][5][4]=28.95;
